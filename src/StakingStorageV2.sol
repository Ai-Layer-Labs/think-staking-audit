 ...
 */
contract StakingStorageV2 is IStakingStorageV2, AccessControl, StakingErrors {
    ...
    /**
     *
     * @param staker The staker to get the stake ids for
     * @return stakeIds The array of ALL GENERATED stake ids for the staker
     */
    ...
    function removeStake(
        ...
        // Ownership is now validated in the StakingVaultV2 before this call.
        ...
        if (_stakers[staker].activeStakesNumber == 0) {
            _allStakers.remove(staker);
        }
    }
    ...
    // ═══════════════════════════════════════════════════════════════════
    //                        INTERNAL FUNCTIONS // TODO : which ones to keep?
    // ═══════════════════════════════════════════════════════════════════
    ...
    function _getStakerBalanceAt(
        ...
        if (targetDay >= checkpoints[nCheckpoints - 1])
            return _stakerBalances[staker][checkpoints[nCheckpoints - 1]];
