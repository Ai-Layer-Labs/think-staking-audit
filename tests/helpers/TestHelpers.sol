...
contract TestHelpers is Test {
  ...
  function setUpContracts() public {
    ...
    vault = new StakingVault(IERC20(token), address(stakingStorage), admin, manager);
  ...
  function createStake(address staker, uint128 amount, uint16 daysLock) public returns (bytes32) {
